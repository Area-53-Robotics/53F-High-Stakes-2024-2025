...
void autonomous() {
   ...
   chassis.turnToHeading(125, 1000);
   intake.move(127);
   chassis.moveToPose(27, 5, 125, 1500, {.maxSpeed = 127, .earlyExitRange = 0.1});
   chassis.waitUntilDone();
   //chassis.moveToPose(22, 8, 125, 1000, {.forwards = false, .maxSpeed = 127});
   pros::delay(1000);
   //intake.move(-127);
   //pros::delay(500);
   intake.move(0);
   ...
   chassis.waitUntilDone();
   //chassis.setPose(22, 8, 170);
   //chassis.moveToPoint(24, 12, 1000, {.maxSpeed = 50});
   //intake.move(127);
   //chassis.waitUntilDone();
